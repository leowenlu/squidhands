export default {
  ...
  'pages.login.password.old.placeholder': 'Enter your current password',
  'pages.login.password.new.placeholder': 'Enter your new password',
  'pages.login.password.confirm.placeholder': 'Re-enter your new password to confirm',
